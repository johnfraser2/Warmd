...
class $en extends MessageLookupByLibrary {
  ...
  final messages = {
		...
		"generalAdvice" : MessageLookupByLibrary.simpleMessage("Your own impact is insignificant comparing to governments's ones, and as of today their ecological politics are far from sufficient. If you can, try to influence their decisions, by voting or via other means."),
		...
		"aboutPart1" : MessageLookupByLibrary.simpleMessage("Warmd is open-source (under GPLv3 license):\nhttps://github.com/FredJul/Warmd\n\nMainly based on https://coolclimate.org 's 2019 results, with the help of other sources:"),
		"aboutPart2" : MessageLookupByLibrary.simpleMessage("Graphical ressources:"),
...
class $fr extends MessageLookupByLibrary {
  ...
  final messages = {
		...
		"generalAdvice" : MessageLookupByLibrary.simpleMessage("Votre propre impact est insignifiant par rapport à celui des gouvernements, et aujourd'hui leurs politiques écologiques sont loin d'être suffisantes. Si vous pouvez, essayez d'influencer sur leurs décisions, via les élections ou par d'autres moyens."),
		...
		"disclaimerExplanation" : MessageLookupByLibrary.simpleMessage("En raison de la complexité de la tâche, je ne m'attends pas à ce que cette application soit très précise, mais elle vous donne une idée de votre impact. Il est possible de trouver des valeurs différentes ailleurs, mais ces sources ignorent parfois certains éléments tels que l’impact des produits importés.\n\nEn outre, cette application se concentre uniquement sur notre empreinte carbone, mais il ne faut pas pour autant oublier les autres types de pollutions (plastiques, pesticides, …).\n\nJe ne suis affilié à aucune des organisations mentionnées."),
		"aboutPart1" : MessageLookupByLibrary.simpleMessage("Warmd est open-source (sous licence GPLv3):\nhttps://github.com/FredJul/Warmd\n\nBasé principalement sur les résultats 2019 de https://coolclimate.org , avec l'aide d'autres sources :"),
		"aboutPart2" : MessageLookupByLibrary.simpleMessage("Ressources graphiques :"),
