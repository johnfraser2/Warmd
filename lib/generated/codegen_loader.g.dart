...
class CodegenLoader extends AssetLoader {
  ...
  static const Map<String, dynamic> en = {
    ...
    "politicalAdvice":
        "Your own impact is insignificant compared to your government, and as of today their ecological policies are far from sufficient.\n\nIf you can, try to influence their decisions, by voting or via other means.",
    ...
    "meatCriteriaExplanation":
        "The meat is a major greenhouse gas emiter. The beef and lamb emit more than 3 times more greenhouse gas than chicken and more than 5 times more greenhouse gas than most vegetables.",
    "meatCriteriaAdvice":
        "Adults don't need more than 2-3 meat meals per week (a bit more for kids). You should not exceed that number and consider that chicken is at least 3 times less polluting than beef.\n\nYou could even substitute meat with some vegetables rich in protein and iron such as lentils, quinoa, beans, tofu, seitan or even insects to help balance a healthy diet. But pay attention to avoid potential deficiencies.",
    ...
    "overweightCriteriaAdvice":
        "Overweight not only has consequences for your health, but also for the planet. You can kill two birds with one stone by simply reducing meats, drinks, snacks and other highly transformed foods that often have a significant carbon impact.\n\nAlmost 10% of the food made available to consumers worldwide is lost through overeating.",
    ...
    "internetCriteriaAdvice":
        "Reduce your carbon footprint by reducing the video streaming quality to 480p maximum (SD), or simply consider reading books instead.",
    ...
    "globalObjectivesPart1":
        "To stay below +2°C, we need to (a https://www.ipcc.ch/site/assets/uploads/sites/2/2019/03/ST1.5_final_310119.pdf)cut our greenhouse gas emissions(/a) by (b)20% by 2030(/b) and (b)stop emitting any by 2075(/b).",
    ...
    "globalActionsPart2":
        "• The first thing to do is to (b)completely stop using fossil fuels(/b) (coal, oil, gas) and replace them with carbon-free electricity ((a https://www.ipcc.ch/site/assets/uploads/2018/02/ipcc_wg3_ar5_chapter7.pdf)IPCC(/a) recommands an increased use of both nuclear and renewable energy).\n\n• Then there is a need for (b)better food management(/b), with less meat production and waste.\n\n• To finish, it could be necessary to start organizing a global degrowth and a birth rate control since it could be the only solution to reach a complete decarbonization.",
  ...
  static const Map<String, dynamic> fr = {
    ...
    "politicalAdvice":
        "Votre propre impact est insignifiant par rapport à celui des gouvernement, et aujourd'hui leurs politiques écologiques sont loin d'être suffisantes.\n\nSi vous le pouvez, essayez d'influencer sur leurs décisions, via les élections ou par d'autres moyens.",
    ...
    "snacksCriteriaAdvice":
        "Préférez les fruits et les légumes aux collations ou aliments transformés. Préférez également l'eau aux boissons.",
    ...
    "overweightCriteriaAdvice":
        "Le surpoids a des conséquences sur votre santé mais aussi sur la planète. Vous pouvez faire d'une pierre deux coups en réduisant les viandes, boissons, collations et autres plats fortement transformés qui ont souvent un impact carbone important.\n\nPrès de 10% des aliments mis à la disposition des consommateurs dans le monde entier sont perdus par la surconsommation.",
    ...
    "internetCriteriaAdvice":
        "Réduisez votre empreinte carbone en réduisant la qualité de streaming vidéo à 480p maximum (SD), ou envisagez simplement de lire des livres à la place.",
    ...
    "globalObjectivesPart1":
        "Pour rester en dessous de +2°C, nous avons besoin (a https://www.ipcc.ch/site/assets/uploads/sites/2/2019/03/ST1.5_final_310119.pdf)de réduire nos émissions de gaz à effet de serre(/a) de (b)20% d'ici 2030(/b) et (b)d'arrêter d'en émettre d'ici 2075(/b).",
    "globalObjectivesPart2":
        "Pour l'instant, il est peu probable que cela se produise. Jusqu'à présent, nous avons constamment augmenté nos émissions et il n'y a pas encore de signe visible de réduction.\n\nAvec la tendance actuelle et sans efforts efficaces, nous nous retrouverons avec au minimum (b)+4°C d'ici 2100(/b).",
