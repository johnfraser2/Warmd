...
static const Map<String,dynamic> en = {
  ...
  "generalAdvice": "Your own impact is insignificant compared to your government or even company one, and as of today their ecological policies are far from sufficient.\n\nIf you can, try to influence their decisions, by voting or via other means.",
  ...
  "globalObjectivesPart1": "To stay below +2°C, we need to (a https://www.ipcc.ch/site/assets/uploads/sites/2/2019/03/ST1.5_final_310119.pdf)cut our greenhouse gas emissions by (b)20% by 2030 and stop emitting any by 2075(/b)(/a).",
  "globalObjectivesPart2": "So far, it is unlikely to happen. Until now we constantly increased our emissions and there is still no clear sign of reduction.\n\nWith the current trend and without effective efforts, we will end up with (b)+4°C/+6°C by 2100(/b), which is the same difference of temperature between (b)the previous ice age and the 20th century(/b).",
